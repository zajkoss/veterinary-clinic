...
public class BeansConfig {
    ...
    public ApplicationRunner dataInitializer(DoctorRepository doctorRepository, PatientRepository patientRepository, VisitRepository visitRepository) {
        return args -> {
            Doctor doctor1 = new Doctor("Jan", "Kowalski", new BigDecimal("100.0"), "1234567890", true, DoctorType.EYE_DOCTOR, AnimalType.CAT,new HashSet<>());
            Doctor doctor2 = new Doctor("Mirosław", "Janko", new BigDecimal("110.0"), "1234567891", true, DoctorType.CARDIOLOGIST, AnimalType.DOG,new HashSet<>());
            Doctor doctor3 = new Doctor("Arkadiusz", "Małysz", new BigDecimal("2220.0"), "1234567892", true, DoctorType.CARDIOLOGIST, AnimalType.CAT,new HashSet<>());
            Doctor doctor4 = new Doctor("Tomasz", "Kubica", new BigDecimal("30.0"), "1234567893", true, DoctorType.EYE_DOCTOR, AnimalType.DOG,new HashSet<>());
            Doctor doctor5 = new Doctor("Katarzyna", "Lewandowska", new BigDecimal("56.0"), "1234567894", true, DoctorType.DENTIST, AnimalType.HORSE,new HashSet<>());
            Doctor doctor6 = new Doctor("Anna", "Kowalczyk", new BigDecimal("44.0"), "1234567895", true, DoctorType.SURGEON, AnimalType.DOG,new HashSet<>());
            ...
            Patient patient1 = new Patient("Szarik", "Pies", "Owczarek", 1, "Tomasz", "Paluch", "lukz1184@gmail.com",new HashSet<>());
            Patient patient2 = new Patient("Filemon", "Kot", "Dachowiec", 5, "Dorota", "Mieszko", "lukz1184@gmail.com",new HashSet<>());
            Patient patient3 = new Patient("Felix", "Kon", "Czystej krwi arabskiej", 7, "Janina", "Dudu", "lukz1184@gmail.com",new HashSet<>());
            Patient patient4 = new Patient("Grizzli", "Pies", "Sznaucer", 3, "Marek", "Kowal", "lukz1184@gmail.com",new HashSet<>());
            Patient patient5 = new Patient("Łapka", "Pies", "Maltańczyk", 4, "Marek", "Kowal", "lukz1184@gmail.com",new HashSet<>());
